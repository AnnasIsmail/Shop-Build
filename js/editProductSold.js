...
function addData(){
    ...
    if(valid === true){
        dataArray = [];
        dataDetail = {
            idSold: parseInt(detailProductSoldId),
...
function goToRemove(id){
    dataArray = [];
    detailProductSold.forEach(data=>{
        if(parseInt(id) === parseInt(data.idProduct) && parseInt(detailProductSoldId) === parseInt(data.idSold)){
...
function submitEdit(){
    ...
    if(valid === true){
        ...
        dataAfterEdit = {
            id: parseInt(detailProductSoldId),
        ...
        productSold.forEach(data => {
            if(data.id === parseInt(detailProductSoldId)){
